...
class SetCommentRepository {
  ...
  Future<Map<String, dynamic>> setComment({required String userId, required String parentId, required String newsId, required String message}) async {
    final result = await _setCommentRemoteDataSource.setComment(userId: userId, parentId: parentId, newsId: newsId, message: message);
