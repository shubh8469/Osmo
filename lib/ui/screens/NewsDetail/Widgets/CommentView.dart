  ...
  Widget commentView() {
    return BlocBuilder<CommentNewsCubit, CommentNewsState>(builder: (context, state) {
      if (state is CommentNewsFetchInProgress || state is CommentNewsInitial) {
        return Center(
          child: showCircularProgress(true, UiUtils.getColorScheme(context).primaryContainer),
        );
      }
      ...
      return Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              if (state is CommentNewsFetchSuccess) allCommentView((state).commentNews.length),
                ...
                SizedBox(
                  ...
                  child: Center(
                    child: CustomTextLabel(
                      text: (state.errorMessage.contains(ErrorMessageKeys.noInternet)) ? UiUtils.getTranslatedLabel(context, 'internetmsg') : state.errorMessage,
