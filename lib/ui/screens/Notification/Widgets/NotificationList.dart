                      ...
                      ? InkWell(
                          ...
                          child: Text((model.isReadMore) ? UiUtils.getTranslatedLabel(context, 'readLessLbl') : UiUtils.getTranslatedLabel(context, 'readMoreLbl'),
                              style: Theme.of(context).textTheme.bodySmall?.copyWith(
                                    ...
                                    color: UiUtils.getColorScheme(context).primary.withOpacity(0.7),
                                  )))
      ...
      builder: (context, state) {
        ...
        if (state is NotificationFetchFailure) {
          return ErrorContainerWidget(
              errorMsg: (state.errorMessage.contains(ErrorMessageKeys.noInternet)) ? UiUtils.getTranslatedLabel(context, 'internetmsg') : state.errorMessage, onRetry: refreshNotification);
        }
