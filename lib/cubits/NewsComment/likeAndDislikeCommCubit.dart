...
class LikeAndDislikeCommCubit extends Cubit<LikeAndDislikeCommState> {
  ...
  void setLikeAndDislikeComm({required String userId, required CommentModel comment, required String status, required bool fromLike}) {
    emit(LikeAndDislikeCommInProgress());
    _likeAndDislikeCommRepository
